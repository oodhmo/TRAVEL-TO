...
const fetchTourInfo = (query: IParam): Promise<any> => {
...
//listYN = N : 결과 개수 가져옴
const fetchTourItemsCount = (query: IParam) => {
...
//축제 행사 정보
const fetchFestivalInfo = (query : IParam) => {
...
//레포츠 정보
const fetchLeisureInfo = (query:IParam) => {
...
//상세정보
const fetchContentDetail = (contentId: string | string[]): Promise<IDetailResponse> => {
...
//검색
const fetchSearchResult = (query: IParam) => {
